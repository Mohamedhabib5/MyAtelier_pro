...
const settingsText = {
  ar: {
    ...
    appearance: {
      ...
      sidebarColor: 'لون القائمة الجانبية (بداية)',
      sidebarColorEnd: 'لون القائمة الجانبية (نهاية)',
      headerColor: 'لون الشريط العلوي (بداية)',
      headerColorEnd: 'لون الشريط العلوي (نهاية)',
      textColor: 'لون النصوص والأيقونات',
      darkMode: 'تفعيل الوضع الليلي (Dark Mode)',
    ...
    tabs: {
      ...
      company: 'الشركة والفروع',
      backups: 'النسخ الاحتياطي',
      financial: 'القواعد المالية',
      departments: 'الأقسام',
      services: 'الخدمات',
  ...
  en: {
    ...
    appearance: {
      ...
      sidebarColor: 'Sidebar Background (Start)',
      sidebarColorEnd: 'Sidebar Background (End)',
      headerColor: 'Header Background (Start)',
      headerColorEnd: 'Header Background (End)',

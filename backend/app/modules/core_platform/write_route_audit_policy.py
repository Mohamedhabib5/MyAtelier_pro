...
WRITE_ROUTE_AUDIT_POLICY: dict[WriteRouteKey, tuple[str, ...]] = {
    ...
    ("POST", "/api/exports/schedules/run-due-reports"): ("automation.job_run",),
    ...
    ("POST", "/api/exports/daily-reports"): ("export.daily_report_config_created",),
    ("PATCH", "/api/exports/daily-reports/{config_id}"): ("export.daily_report_config_updated",),
    ("DELETE", "/api/exports/daily-reports/{config_id}"): ("export.daily_report_config_deleted",),
    ("POST", "/api/exports/daily-reports/{config_id}/test"): ("export.daily_report_config_test_run",),

...
def serialize_disbursement(voucher: DisbursementVoucher) -> dict:
    return {
        ...
        "expense_account_id": voucher.expense_account_id,
        "expense_account_code": voucher.expense_account.code if voucher.expense_account else None,
        "expense_account_name": voucher.expense_account.name if voucher.expense_account else None,
